...
Img=utils.translation(img,100,100)
utils.draw(Img,2,'translation')
Img=utils.rotate(img,-30)
utils.draw(Img,3,'rotate')
Img=utils.euclid(img,-100,100,45)
utils.draw(Img,4,'Euclid')
Img=utils.similar(img,2,2,-100,100,45)
utils.draw(Img,5,'similar')
Img=utils.affine(img,0.5,0,50,0.4,0.7,100)
